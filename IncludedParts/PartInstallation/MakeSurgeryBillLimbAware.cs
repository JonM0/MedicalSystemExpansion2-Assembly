    ...
    static class MakeSurgeryBillLimbAware
    {
        ...
        */
        ...
        public static IEnumerable<CodeInstruction> Transpiler ( IEnumerable<CodeInstruction> instructions, ILGenerator iLGenerator )
        {
            ...
            var constructorBillMedical = typeof( Bill_Medical ).GetConstructor( new Type[] { typeof( RecipeDef ) } );
            var constructorBillMedicalLimbAware = typeof( Bill_MedicalLimbAware ).GetConstructor( new Type[] { typeof( RecipeDef ) } );
